...
class CiphertextSet(object):
    ...
    def mult(self, other, r, params, relin_version):
        ...
        #r1.var = params["n"] * r.inf_norm * self.var * params["t"]
        #r1.pt.inf_norm = params["delta"] * params["h"] * params["t"]**2 /12
        r2 = CiphertextSet.mult_plain(
            other, r, params
        )  # Var(r * v2) = n * Var(r) * Var(v2)
        #r2.var = params["n"] * r.inf_norm * self.var * params["t"]
        #r2.pt.inf_norm = params["delta"] * params["h"] * params["t"]**2 /12
